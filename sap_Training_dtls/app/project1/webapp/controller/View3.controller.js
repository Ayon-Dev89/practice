sap.ui.define([
    ...
    return Controller.extend("com.cg.ayon.project1.controller.View3", {
        onInit() {
             ...
             formatter: {
              ...
              onCreate: function () {
                if (!this._oCreateDialog) {
                  this._oCreateDialog = sap.ui.xmlfragment("com.cg.ayon.project1.view.CreateDialog", this);
              ...
              onUpdate:function(){
                ...
                if (!this._oUpdateDialog) {
                  this._oUpdateDialog = sap.ui.xmlfragment("com.cg.ayon.project1.view.UpdateDialog", this);
